/* ==========================================================================
   ...
   教材与选本的文本**真会不一样**，是文献上的差别、不是录入出错：
     ...
     · 《静夜思》 教材与《唐诗三百首》正文一致（都是「床前明月光」的教材文本）→ 合并为同一篇
   ...
   课内数据里曾有 12 组篇目在**两个年级**各存了一份（正文一字不差），
   是逐页录入留下的自身重复 —— 与「课内 ↔ 选集」的跨集重复不同，
   它连出处都一样，纯粹是同一份教材内容存了两遍（《绝句》二年级下 / 三年级下、
   《师说》高一上 / 高三下……）。已按**低年级版本为准**各删一条
   （学生先学到低年级那条），课内条目由 273 降到 261，本表组数由 66 降到 57。
   跨集那 3 组（登高 / 念奴娇·赤壁怀古 / 永遇乐·京口北固亭怀古）只删课内自身那份，
   与选集的判重照旧。
