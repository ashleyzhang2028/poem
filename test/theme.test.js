...
// 宣纸底
chk(/--bg:\s*#f8f4ea/.test(css), '底色为素绢米灰 #f8f4ea（在 #f3eee2 基础上进一步调淡）');
chk(/--card:\s*#fffdf8/.test(css), '卡片为宣纸白 #fffdf8');
// 传统色名
...
chk(/"background_color":\s*"#f8f4ea"/.test(read('manifest.webmanifest')), 'PWA 清单背景色为素绢（与 --bg 同步变淡）');
