...
chk(sb.WORKS_GROUPS.length === 139,
  '同篇对照表 139 组（乐府集与成语故事收进来的一批重篇 + 长文补全带来的同篇，Issue #244 / #308；' +
  '二批带来源的古文 / 诗篇条目并回原篇；' +
  'Issue #339 拆掉 5 组错并（愚公移山 / 卧薪尝胆 / 礼贤下士 / 不自量力 / 东道主）由 142 降为 140；' +
  '本轮又把 众志成城 / 众口铄金 这一组「正文撞巧相同」的拆开，降为 139；实际 ' +
