...
/* ========== 六之二、2.2：两份名单分开写、分开渲染，一份也不许说成另一份 ========== */
{
  ...
  */
  ...
  /* ⚠️ 2026-09-17 用户裁决之后口径变了（4 期整期取消），这一条跟着改口：
     原先要界面写「本站现在**没有收款能力**（4 期才做）」—— 现在不是「还没做」，
     而是「**不做**」。要守的实质没变：**权威 ≠ 付费凭据**，一个字都不许
     让人读成「已经能收费了」。 */
  chk(/不收款|没有收款能力/.test(adminVisible) && /不是付费凭据|不是收费凭据/.test(adminVisible),
    '服务端那一块明说「本站不收款、这一份不是付费凭据」（权威 ≠ 能收钱）');
